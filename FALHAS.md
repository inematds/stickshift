...
|---|---|---|---|
| 2026-09-24 | (branch macOS catalogo-modelos) Codex 0.156.1 passou a mostrar "GPT-6-Astra" no rodapé e pôs Max/Ultra num submenu: o parser ObjC (regex só `gpt-` minúsculo) e o plano de esforço recusariam toda troca no Codex | regex sem distinção de maiúsculas + normalizar para o slug do catálogo; plano passa por "More reasoning…" → "Advanced Reasoning" | infra |
